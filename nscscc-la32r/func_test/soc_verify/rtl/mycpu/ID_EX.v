...
module ID_EX (
    ...
    always @(posedge cpu_clk) begin
        ...
        alu_op_out     <= !cpu_rstn || pred_error ?  4'h0 : suspend ? alu_op_out     : alu_op_in;
        alua_sel_out   <= !cpu_rstn || pred_error ?  1'h0 : suspend ? alua_sel_out   : alua_sel_in;
        alub_sel_out   <= !cpu_rstn || pred_error ?  1'h0 : suspend ? alub_sel_out   : alub_sel_in;
